...
\author[TODO]{Francesco Innocenzi 2087246\\{}Luca Festugato 2064594}
\date{[TODO: Presentation Date]}
...
\input{slides/01_outline.tex}
\input{slides/02_problem_statement.tex}
\input{slides/03_state_of_the_art.tex}
\input{slides/04_architecture.tex}
\input{slides/05_frequency_branch.tex}
\input{slides/06_training_strategy.tex}
\input{slides/07_dataset.tex}
\input{slides/08_experimental_setup.tex}
\input{slides/09_results.tex}
\input{slides/10_robustness.tex}
\input{slides/11_gradcam.tex}
\input{slides/12_conclusions.tex}
\input{slides/13_references.tex}
